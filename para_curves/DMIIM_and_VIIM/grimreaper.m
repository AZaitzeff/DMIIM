...
for t=1:nt
  ...
  if impl
      ...
      [inx,iny] = kevolvefullyimplict(dt,ren,inx,iny,S1,1,4,dir,1/(N^2)*factor);
      [nx2,ny2] = kevolvefullyimplict(dt,ren,nx2,ny2,S2,1,0,dir,1/(N^2)*factor);
  else
      [inx,iny] = kevolve(dt,ren,inx,iny,S1,1,4,dir,2);
      [nx2,ny2] = kevolve(dt,ren,nx2,ny2,S2,1,0,dir,2);
  end
